...
def main() -> int:
    parser = argparse.ArgumentParser(description="Create a Feishu Slides presentation from a local Markdown outline.")
    ...
    result = create_slides_from_markdown(args.markdown_path, args.title, dry_run=not args.execute)
